...
import carla
from core.utils.simulator_utils.carla_agents.navigation.basic_agent import BasicAgent, LocalPlanner
...
from core.simulators.srunner.scenariomanager.actorcontrols.actor_control import ActorControl
from core.simulators.srunner.scenariomanager.timer import GameTime
from core.simulators.srunner.tools.scenario_helper import detect_lane_obstacle
from core.simulators.srunner.tools.scenario_helper import generate_target_waypoint_list_multilane

from core.simulators import srunner
...
def calculate_distance(location, other_location, global_planner=None):
    ...
    try:
        ...
        return location.distance(other_location.location)
