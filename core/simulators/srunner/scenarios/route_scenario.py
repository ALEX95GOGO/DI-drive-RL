...
SCENARIO_CLASS_DICT = {
    ...
    'CuttingInStationaryObject': CuttingInStationaryObject,
    'CuttingInActiveObject': CuttingInActiveObject,
    'OccludedCrossingJunction': OccludedCrossingJunction,
    'OccludedLeftCrossingJunction': OccludedLeftCrossingJunction,
...
class RouteScenario(BasicScenario):
    ...
    def _update_route(self, world, config, debug_mode):
        ...
        self.timeout = self._estimate_route_timeout()*3
