...
class ScenarioCarlaEnvCamEval(BaseDriveEnv):
    """
    ...
    def reset(self,i):
        ...
        rgb1 = self.get_observations()['segmentation1']
        rgb2 = self.get_observations()['segmentation2']
        rgb3 = self.get_observations()['segmentation3']
