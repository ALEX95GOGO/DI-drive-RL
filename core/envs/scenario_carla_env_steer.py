...
class ScenarioCarlaEnv4(BaseDriveEnv):
    """
    ...
    action_space = spaces.Box(low=-1.0, high=1.0, shape=(2,), dtype=np.float16)
    ...
    def reset(self):
        ...
        random_integer = (self._carla_port-9000)
    ...
    def step(self, action):
        ...
        self.delta_steer = np.abs(action['steer']-self.last_steer)
