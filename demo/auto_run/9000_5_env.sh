...
gnome-terminal -- bash -c "SINGULARITYENV_SDL_VIDEODRIVER=offscreen singularity exec --nv -e ../../../carla-0.9.11.sif /home/carla/CarlaUE4.sh -carla-port=9000; exec bash" 
