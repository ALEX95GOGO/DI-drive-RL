...
from core.envs import DriveEnvWrapper, ScenarioCarlaEnv_fixed_n1
...
def main(args, cfg, seed=0):
    ...
    carla_env = DriveEnvWrapper(ScenarioCarlaEnv_fixed_n1(cfg.env, cfg.policy, configs, args.host, args.port))
    carla_env.seed(seed)
    set_pkg_seed(seed)
