...
from core.envs import DriveEnvWrapper, ScenarioCarlaEnv3,CarFollowing, LeftTurn
...
def main(args, cfg, seed=0):
    ...
    ports = [9000, 9002, 9004, 9006, 9008, 9010, 9012, 9014, 9016, 9018, 9020, 9022,9024,9026,9028,9030,9032,9034,9036,9038,9040,9042,9044,9046,9048,9050,9052,9054,9056,9058]
    #ports = [9040,9042,9044,9046,9048,9050,9052,9054,9056,9058]
    ...
    def make_env(port, routes, scenarios):
        def _init():
            ...
            elif port >=9040 and port <9050:
                env = LeftTurn(port=port)
            elif port >=9050 and port <9060:
                env = CarFollowing(port=port)
            env.seed(seed)
            return env
        return _init
