...
from core.envs import DriveEnvWrapper, ScenarioCarlaEnv_fixed_n2
...
def main(args, cfg, seed=0):
    ...
    carla_env = DriveEnvWrapper(ScenarioCarlaEnv_fixed_n2(cfg.env, cfg.policy, configs, args.host, args.port))
    carla_env.seed(seed)
    set_pkg_seed(seed)
