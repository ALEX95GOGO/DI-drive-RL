...
from core.envs import DriveEnvWrapper, ScenarioCarlaEnv,ScenarioCarlaEnv_1cam
...
import numpy as np
import csv
from parellel_train_1cam import CustomCNN
...
def main(args, cfg, seed=0):
    ...
    carla_env = ScenarioCarlaEnv_1cam(cfg.env, cfg.policy ,routes, scenario_file, single_route, args.host, args.port)
    carla_env.seed(seed)
    set_pkg_seed(seed)
    ...
    for k in range(total_timesteps):
        ...
        if dones:
            ...
            output_file_path='output_dos2.csv'
