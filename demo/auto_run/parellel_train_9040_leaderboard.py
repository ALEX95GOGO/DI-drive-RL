...
from core.envs import DriveEnvWrapper, ScenarioCarlaEnv3, ScenarioCarlaEnv_1cam, ScenarioCarlaEnvLeaderboard
...
#            self.logger.record("episode/reward", reward_sum)
#        return True
...
class SaveOnBestTrainingRewardCallback(BaseCallback):
    ...
    def __init__(self, check_freq, save_path, verbose=1):
        ...
        self.best_mean_reward = -np.inf
        self.best_model_path = os.path.join(save_path, 'best_modelmixed2')
...
class CustomCNN(BaseFeaturesExtractor):
    ...
    def forward(self, observations: torch.Tensor) -> torch.Tensor:
        ...
        with torch.no_grad():
            ...
            checkpoint = torch.load('human_model/new/model_epoch_3.tar')
...
def main(args, cfg, seed=0):
    ...
    #ports = [9000, 9002, 9004, 9006, 9008, 9010, 9012, 9014, 9016, 9018, 9020, 9022,9024,9026,9028,9030,9032,9034,9036,9038]
    ports = [9040 + 2*i for i in range(20)]

    #ports = [9000, 9002, 9004, 9006, 9008, 9010, 9012, 9014]
    ...
    #import pdb; pdb.set_trace()
    routes = ['/data/zhuzhuan/DI-drive/core/data/casezoo/routes/DOS_01_town05.xml',
            '/data/zhuzhuan/DI-drive/core/data/casezoo/routes/DOS_02_town05.xml',
            '/data/zhuzhuan/DI-drive/core/data/casezoo/routes/DOS_03_town05.xml',
            '/data/zhuzhuan/DI-drive/core/data/casezoo/routes/DOS_04_town05.xml']
    scenarios = ['/data/zhuzhuan/DI-drive/core/data/casezoo/configs/DOS_01_town05.json',
            '/data/zhuzhuan/DI-drive/core/data/casezoo/configs/DOS_02_town05.json',
            '/data/zhuzhuan/DI-drive/core/data/casezoo/configs/DOS_03_town05.json',
            '/data/zhuzhuan/DI-drive/core/data/casezoo/configs/DOS_04_town05.json']
            
    routes = ['/projects/MAD3D/nips2024/InterFuser/leaderboard/data/training_routes/routes_town01_tiny.xml',
            '/projects/MAD3D/nips2024/InterFuser/leaderboard/data/training_routes/routes_town02_tiny.xml',
            '/projects/MAD3D/nips2024/InterFuser/leaderboard/data/training_routes/routes_town03_tiny.xml',
            '/projects/MAD3D/nips2024/InterFuser/leaderboard/data/training_routes/routes_town04_tiny.xml']
    scenarios = ['/projects/MAD3D/nips2024/InterFuser/leaderboard/data/scenarios/town01_all_scenarios.json',
            '/projects/MAD3D/nips2024/InterFuser/leaderboard/data/scenarios/town02_all_scenarios.json',
            '/projects/MAD3D/nips2024/InterFuser/leaderboard/data/scenarios/town03_all_scenarios.json',
            '/projects/MAD3D/nips2024/InterFuser/leaderboard/data/scenarios/town04_all_scenarios.json']
    
    routes = ['/projects/MAD3D/nips2024/DI-drive/core/data/srunner/routes_training.xml',
            '/projects/MAD3D/nips2024/DI-drive/core/data/srunner/routes_training.xml',
            '/projects/MAD3D/nips2024/DI-drive/core/data/srunner/routes_training.xml',
            '/projects/MAD3D/nips2024/DI-drive/core/data/srunner/routes_training.xml']
    scenarios = ['/projects/MAD3D/nips2024/DI-drive/core/data/srunner/all_towns_traffic_scenarios.json',
            '/projects/MAD3D/nips2024/DI-drive/core/data/srunner/all_towns_traffic_scenarios.json',
            '/projects/MAD3D/nips2024/DI-drive/core/data/srunner/all_towns_traffic_scenarios.json',
            '/projects/MAD3D/nips2024/DI-drive/core/data/srunner/all_towns_traffic_scenarios.json']
    
    #routes = ['/data/zhuzhuan/DI-drive/core/data/casezoo/routes/route01.xml',
    #        '/data/zhuzhuan/DI-drive/core/data/casezoo/routes/route02.xml',
    #        '/data/zhuzhuan/DI-drive/core/data/casezoo/routes/route03.xml',
    #        '/data/zhuzhuan/DI-drive/core/data/casezoo/routes/route04.xml']
    #scenarios = ['/data/zhuzhuan/DI-drive/core/data/casezoo/configs/route01.json',
    #        '/data/zhuzhuan/DI-drive/core/data/casezoo/configs/route02.json',
    #        '/data/zhuzhuan/DI-drive/core/data/casezoo/configs/route03.json',
    #        '/data/zhuzhuan/DI-drive/core/data/casezoo/configs/route04.json']
    
    # Function to create and seed each environment
    def make_env(port, routes, scenarios):
        def _init():
            ...
            #env = ScenarioCarlaEnv(cfg.env, configs[0], args.host, port)
            env = ScenarioCarlaEnv3(cfg.env, cfg.policy ,routes[(port-9000)//2%4], scenarios[(port-9000)//2%4], single_route, args.host, port)
            env.seed(seed)
            return env
        return _init
    
    # Create SubprocVecEnv with environments
    envs = SubprocVecEnv([make_env(port,routes,scenarios) for port in ports])
    ...
    #model = SAC("CnnPolicy", envs, verbose=1, buffer_size=10000,policy_kwargs=policy_kwargs, tensorboard_log="./ppo_tensorboard/")

    #render_callback = RenderCallback(render_freq=1)  # Adjust `render_freq` as needed
    callback = RewardLoggerCallback('mixed')
    ...
    # Optionally, save the trained model
    current_time = datetime.datetime.now().strftime("%Y%m%d-%H%M%S")
    filename = "ppo_carla_model_{}_mixed".format(current_time)
    model.save(filename)
    #model.save("ppo_carla_model{}".format('mixed'))
    #import pdb; pdb.set_trace()
    # Train the model
